...
% pandoc's LaTeX output uses \tightlist in itemize/enumerate bodies, and
% \hypertarget for headings; both are normally defined by pandoc's own
% document template (the latter via hyperref), which we bypass since we
% only take fragment output (see scripts/markdown_to_pages.py).
